...
public class FragmentMainPageBindingImpl extends FragmentMainPageBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.qrcodebtn, 1);
        sViewsWithIds.put(R.id.madedeliveriesbtn, 2);
        sViewsWithIds.put(R.id.reqbuttn, 3);
        sViewsWithIds.put(R.id.ridername, 4);
        sViewsWithIds.put(R.id.staticwelcome, 5);
    }
    // views
    @NonNull
